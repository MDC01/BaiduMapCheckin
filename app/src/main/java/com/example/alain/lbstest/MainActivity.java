...
public class MainActivity extends BaseActivity implements SensorEventListener, View.OnClickListener {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //打卡范围
//            mDestinationPoint = new LatLng(location.getLatitude() * 1.0001, location.getLongitude() * 1.0001);//假设公司坐标距离约1km，外勤
            mDestinationPoint = new LatLng(25.034543, 117.025441);//小桔科技坐标
            ...
            if (mDistance <= DISTANCE) {
                //显示文字
                setTextOption(mDestinationPoint, "您已在工作范围内", "#7ED321");
                //目的地图标
                setMarkerOptions(mDestinationPoint, R.mipmap.arrive_icon);
                //按钮颜色
                commit_bt.setBackgroundDrawable(getResources().getDrawable(R.mipmap.company_btbg_yellow));
                mBaiduMap.setMyLocationEnabled(false);
            } else {
                setTextOption(LocationPoint, "您不在工作范围之内", "#FF6C6C");
                setMarkerOptions(mDestinationPoint, R.mipmap.company_icon);
                commit_bt.setBackgroundDrawable(getResources().getDrawable(R.mipmap.company_btbg_gray));
                mBaiduMap.setMyLocationEnabled(true);
            }
...
//        option.setLocationMode(LocationClientOption.LocationMode.Device_Sensors);
    ...
    protected void onDestroy() {
        ...
        if (BDAblistener != null) {
            mLocationClient.unRegisterLocationListener(BDAblistener);
